...
docker run --rm -v /home/ubuntu/immich/demo/library:/import ghcr.io/immich/immich-cli:latest upload --email demo@immich.app --password demo --server https://demo.immich.app/api -d /import -y
docker system prune
